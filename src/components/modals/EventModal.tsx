    ...
    const handlePhotoChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            try {
                ...
                setPhotoProfil(optimizedBase64);
            } catch (err: any) {
                console.error("Erreur optimisation photo événement:", err);
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-slate-50 border border-slate-200/50 rounded-xl p-3 flex flex-col gap-2">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <label className="cursor-pointer bg-white border border-gray-250 hover:bg-gray-100 text-3xs font-extrabold text-gray-800 px-3 py-1.5 rounded-lg shadow-3xs transition">
                                                Choisir l'image...
                                                <input type="file" accept={ACCEPTED_IMAGE_INPUT_ACCEPT} onChange={handlePhotoChange} className="hidden" />
                                            </label>
                                            {photoProfil && (
