...
const FournisseurModal: FC<FournisseurModalProps> = ({ isOpen, onClose, onSave, fournisseurs = [] }) => {
    ...
    const handleLogoChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            if (!validation.valid) {
                setLogoError(validation.error || 'Format invalide. Seuls JPG, JPEG et PNG sont acceptés.');
                return;
            }
            try {
                ...
                console.error("Erreur optimisation logo fournisseur:", err);
                        ...
                        <div className="bg-slate-50/50 border border-dashed border-gray-200 rounded-xl p-4">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-4">
                                ...
                                <div className="flex-1 w-full space-y-2">
                                    ...
                                    <p className="text-[10px] text-gray-400">Formats acceptés : JPG, JPEG, PNG (optimisé automatiquement)</p>
                                    {logoError && (
